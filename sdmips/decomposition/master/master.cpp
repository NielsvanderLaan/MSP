...
d_data(data)
{
  d_mip = new GRBModel(d_data.to_model(env, false));
  d_lp = new GRBModel(d_data.to_model(env, true));
...
{
  d_mip = new GRBModel(*other.d_mip);
  d_lp = new GRBModel(*other.d_lp);
...
d_data(other.d_data),
d_mip(other.d_mip),
d_mip_theta(other.d_mip_theta),
d_mip_xvars(other.d_mip_xvars),
d_lp(other.d_lp),
d_lp_theta(other.d_lp_theta),
d_lp_xvars(other.d_lp_xvars),
d_cuts(other.d_cuts),
d_x_n(other.d_x_n),
d_theta_n(other.d_theta_n)
{
